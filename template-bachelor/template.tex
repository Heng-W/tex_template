...
\begin{document}
    ...
    \begin{titlepage}
        \vspace*{-2.75em}
        {\hskip 10.25cm\bf 编\hspace{0.4em} 号 \qquad }
        ...
        {\zihao{2}
        \makebox[20mm]{\bf 题目：}
        \underline{\makebox[116mm][c]{\sf \art@title}}\\
        \vskip 0.4cm
        \makebox[20mm]{}
    ...
    %中文关键词
    \cnkeyword{关键词0；关键词1；关键词2}

    %英文摘要
    \enabstract{This is XeLaTex. Compile the document twice to create reference.}
    %英文关键词
    \enkeyword{test0; test1; test2}
    ...
    \sect{绪论}
    \bodyfancystyle%正文页眉页脚格式
    
        \subsection{课题研究目的及意义}
    
        这是测试文字\upcite{intro}，这是测试文字这是测试文字这是测试文字。

        这是测试文字这是测试文字这是测试文字这是测试文字这是测试文字这是测试文字这是测试文字这是测试文字\upcite{intro1}。

        这是测试文字这是测试文字这是测试文字这是测试文字这是测试文字\upcite{intro2}。
    ...
    \begin{thebibliography}{99}
        ...
        \bibitem{intro}从树．基于ARM的嵌入式图像识别检测系统的设计[J]．计算机测量与控制，2017，25(9)：36-38．
        
        \bibitem{intro1}王永兵．嵌入式智能视觉测量传感器设计与应用研究[D]．北京：北京理工大学，2015.
        
        \bibitem{intro2}Stauffer C, Eric W, Grimson L. Learning Patterns 
        of Activity Using Real-time Tracking[J]. IEEE Transactions on 
        Pattern Analysis and Machine Intelligence, 2000, 22(8): 747-757.
